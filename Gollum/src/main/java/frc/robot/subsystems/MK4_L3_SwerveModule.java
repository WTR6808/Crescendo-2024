...
public class MK4_L3_SwerveModule extends SubsystemBase {
  ...
  public MK4_L3_SwerveModule(String name,
    ...
    m_driveMotor.setOpenLoopRampRate(0.5); //Added for no PID
  ...
  public void setDesiredState(SwerveModuleState desiredState){
    ...
    //CTRE CAN Coder is configured to return absolute position between -0.5 to 0.5
    //  Multiply be 2Pi to get angular value in radians -Pi to Pi
